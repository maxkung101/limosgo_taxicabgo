...
<title>Taxi Mobile Search</title>
<link rel="stylesheet" href="css/bootstrap.min.css" type="text/css" lang=""/>
<style>
body{ background-color:#049200;font-family:calibri; font-size:18px; letter-spacing:1px; }
...
.container-fluid{background-color:#049200; padding-top: 2%; padding-bottom:10%;}
.container-in{background-color:#ffcc33; padding:2%; margin:auto; border-radius:20px;}
