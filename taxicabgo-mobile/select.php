...
<script>
function switchTab(id1,id2,b1,b2) {
...
<div data-role="page" id="pageone">
	<div data-role="header">
		...
		<h1><img src="images/m6.png" width="50" height="39" alt=""/><br/><em>Taxicab Go</em></h1>
	</div>
...
<div data-role="main" class="ui-content">
	...
	<div class="ui-grid-a" align="center" style="font-size:20px;">
		<div class="ui-block-a">
			<div id="tab1" style="color:#FFF;width:90%;background-color:#888" onClick="switchTab('taxicabgo','limosgo');"><img src="images/taxis.png" width="50" height="39" alt=""> Taxicab Go</div>
		</div>
		<div class="ui-block-b">
			<div id="tab2" style="color:#FFF;width:90%;background-color:#888" onClick="switchTab('limosgo','taxicabgo');"><img src="images/limos.png" width="50" height="39" alt=""> Limos Go</div>
		</div>
	</div>
	<br/>
	<div id="limosgo" style="display:none">
		<div class="ui-grid-a">
	...
	<div id="taxicabgo" style="display:block">
		<div class="ui-grid-a">
			<div class="ui-block-a" align="right">
